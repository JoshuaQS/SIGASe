...
> = {
  ...
  sm: {
    control: 'h-8 rounded-md',
    text: 'text-xs',
    px: 'px-2.5',
    icon: 'h-3.5 w-3.5',
    addonGap: 'gap-1',
    inputStartPadding: 'pl-8',
    inputEndPadding: 'pr-8',
    adornmentInsetStart: 'left-2.5',
    adornmentInsetEnd: 'right-2.5',
  ...
  lg: {
    ...
    adornmentInsetStart: 'left-3.5',
    adornmentInsetEnd: 'right-3.5',
