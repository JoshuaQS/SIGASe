...
} from '@/lib/api/student-portal-api';
        ...
        <div className="grid h-full w-full grid-cols-1 gap-3 xl:grid-cols-12 xl:items-start xl:gap-x-5 xl:gap-y-3">
          ...
          <section className="grid gap-3 xl:col-span-12">
            <div className="grid grid-cols-1 gap-3">
              <Card
                className={cn(
                  'rounded-[1.5rem] border border-border/50 bg-card/40 p-4 shadow-sm backdrop-blur-xl',
                  cardHoverClass,
                )}
              >
                <div className="mb-3 flex items-center text-[11px] font-semibold uppercase tracking-[0.18em] text-muted-foreground">
                ...
                <div className="grid grid-cols-1 gap-x-5 gap-y-3 sm:grid-cols-2 lg:grid-cols-4">
                  <div>
                    ...
                    <div className="text-base font-medium text-foreground">{displayFirstNames} {displayLastNames}</div>
                  </div>
                  <div>
                    <span className="mb-1 block text-[10px] uppercase tracking-[0.22em] text-muted-foreground">
                      Correo institucional:
                    </span>
                    <div className="truncate text-base font-medium text-foreground">{displayEmail}</div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="font-mono text-base font-medium text-foreground">{enrollmentId}</div>
                  </div>
                  ...
                  <div className="lg:col-span-2">
                    ...
                    <div className="flex flex-wrap items-center gap-2">
                      <div className="text-sm font-medium text-foreground lg:text-base">{career}</div>
            ...
            <div className="grid grid-cols-1 gap-3 lg:grid-cols-12 lg:items-stretch lg:gap-3">
              <Card
                className={cn(
                  'rounded-[1.5rem] border border-border/50 bg-card/40 p-4 shadow-sm backdrop-blur-xl lg:col-span-4',
                  cardHoverClass,
                )}
              >
                <div className="mb-3 flex items-center justify-between">
                  <h3 className="flex items-center text-[11px] font-semibold uppercase tracking-[0.18em] text-muted-foreground">
              ...
              <div className="grid min-h-0 grid-cols-1 gap-3 lg:col-span-8 lg:grid-cols-2">
                <Card
                  className={cn(
                    'group relative flex min-h-0 flex-1 flex-col overflow-hidden rounded-[1.5rem] border border-border/50 bg-card/40 p-4 shadow-sm backdrop-blur-xl',
                    portalEffects.zapTrailGroup,
                    cardHoverClass,
                  )}
                >
                  <div className={cn('absolute bottom-0 right-0 translate-x-4 translate-y-4 opacity-20', portalEffects.readingZapIcon)}>
                    <Zap className={cn('h-28 w-28 text-emerald-500/70', portalEffects.readingZap)} strokeWidth={1.35} />
                  </div>
                  ...
                  <div className="relative z-10 flex flex-1 flex-col justify-center">
                    ...
                    <div className="flex items-end gap-2">
                      <span className="bg-gradient-to-br from-foreground to-muted-foreground bg-clip-text text-4xl font-extrabold text-transparent">
                        {streakDays}
                      </span>
                      <span className="pb-0.5 text-base font-medium text-muted-foreground">días</span>
                    </div>
                ...
                <Card
                  className={cn(
                    'flex min-h-0 flex-1 flex-col rounded-[1.5rem] border border-border/50 bg-card/40 p-4 shadow-sm backdrop-blur-xl',
                    cardHoverClass,
                  )}
                >
                  <div className="mb-2 flex items-center text-[11px] font-semibold uppercase tracking-[0.18em] text-muted-foreground">
