...
@Entity
@Table(name = "student_auth_events", indexes = {
        @Index(name = "idx_student_auth_events_occurred_at", columnList = "occurred_at"),
        @Index(name = "idx_student_auth_events_student_id", columnList = "student_id"),
        @Index(name = "idx_student_auth_events_result", columnList = "result"),
        @Index(name = "idx_student_auth_events_norm_email", columnList = "normalized_email"),
        @Index(name = "idx_student_auth_events_auth_method", columnList = "auth_method"),
        @Index(name = "idx_student_auth_events_request_id", columnList = "request_id")
})
public class StudentAuthEvent extends BaseUuidEntity {
    ...
    private StudentAuthMethod authMethod;

    @Enumerated(EnumType.STRING)
    @Column(name = "result", nullable = false, length = 50)
    private StudentAuthResult result;
    ...
    public StudentAuthMethod getAuthMethod() {
        return authMethod;
    }

    public void setAuthMethod(StudentAuthMethod authMethod) {
        this.authMethod = authMethod;
    }

    public StudentAuthResult getResult() {
        return result;
    }

    public void setResult(StudentAuthResult result) {
        this.result = result;
    }
